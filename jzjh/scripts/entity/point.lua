...
--复制点
function mt:copy()
    return et.point(self[1], self[2], self[3])
end
...
--    return et.point_effect(self, data)
--end
...
function point:__add(data)
    return et.point(self[1] + data[1], self[2] + data[2], self[3] + (data[3] or 0))
end
...
function point:__sub(data)
    ...
    return et.point(x + distance * math.cos(angle), y + distance * math.sin(angle))
end
